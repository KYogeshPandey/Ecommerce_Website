...
export const InteractiveLamp = ({
  lampOn = false,
  onToggle,
  currentTheme = LAMP_PALETTES[0],
  className = "w-full lg:w-[35%] flex flex-col items-center justify-center relative select-none",
}) => {
  ...
  // The ONLY function that triggers the parent lamp toggle
